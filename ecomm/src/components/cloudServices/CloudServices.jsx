        ...
        <>
            ...
            <div className="container-fluid p-0 m-0 ">
                <div className="row p-0 m-0 justify-content-center">
                    <div className="col-md-12 text-center top_section">
                        <div className="content mx-1">
                            <img src={cloud} alt="" className='me-1' />
                            <h2>Innovate with Cloud</h2>
                            <p className='mt-3'>Elevate operations, scale effortlessly, and innovate seamlessly with cloud computing</p>
                            <div className="row justify-content-center">
                                <div className="col-auto">
                                    <Link className='btn py-2 px-3 shadow  mt-md-3 mt-sm-1'><span className='material-icons-outlined me-1'>cloud_done</span> Cloud Computing</Link>
                                </div>
                            </div>
                        </div>
                    </div>
